...
use App\Filament\I2cAdmin\Resources\System\UserResource\Pages;
use App\Filament\I2cAdmin\Resources\System\UserResource\RelationManagers;
...
class UserResource extends Resource
{
    ...
    protected static function getTableColumns(): array
    {
        return [
            ...
            Tables\Columns\TextColumn::make('name')
                ...
                ->sortable(),
            // Tables\Columns\TextColumn::make('ownTenants.name')
            //     ->label(__('Conta(s)'))
            //     ->badge()
            //     ->searchable()
            //     // ->sortable()
    ...
    {
        return [
            // Tables\Filters\SelectFilter::make('tenant_accounts')
            //     ->label(__('Conta(s) de cliente(s)'))
            //     ->relationship(
            //         name: 'ownTenants',
            //         titleAttribute: 'name',
            //     )
