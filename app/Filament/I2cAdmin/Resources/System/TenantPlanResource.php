...
use App\Filament\I2cAdmin\Resources\System\TenantPlanResource\Pages;
use App\Filament\I2cAdmin\Resources\System\TenantPlanResource\RelationManagers;
    ...
    protected static function getTableColumns(): array
    {
        return [
            ...
            Tables\Columns\TextColumn::make('annual_price')
                ...
                ->description(
                    fn(TenantPlan $record): ?string =>
                    $record->display_annual_discount_margin ? 'economia de ' . $record->display_annual_discount_margin : null,
                )
                ->sortable()
                ->toggleable(isToggledHiddenByDefault: false),
